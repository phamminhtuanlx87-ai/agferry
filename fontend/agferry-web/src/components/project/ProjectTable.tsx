...
export default function ProjectTable({ projects, rowsPerPage = 5 }: ProjectTableProps) {
    ...
    <div className="mt-6 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <thead className="bg-gray-50 text-gray-500 uppercase tracking-wider text-xs font-semibold">
            <tr>
              ...
              <th className="px-6 py-4 hidden md:table-cell text-center">
                Ngày tạo<br/>Công trình
              </th>
              <th className="px-6 py-4 text-center min-w-40">QĐ phê duyệt <br/>Dự Toán</th>
              <th className="px-6 py-4 hidden md:table-cell text-center min-w-40">
                QĐ phê duyệt <br/>Dự Toán (Điều chỉnh)
              </th>
      ...
      <div className="flex items-center justify-between px-6 py-4 border-t border-gray-100">
        <p className="text-sm text-gray-500">
          Hiển thị {start + 1} - {Math.min(end, totalItems)} của {totalItems}{" "}
          công trình
        </p>
