  ...
  return (
    <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
      ...
      <div className="bg-slate-50 px-4 py-3 border-b border-slate-200 flex justify-between">
        <h3 className="font-bold text-blue-800 text-sm uppercase">I. Thông tin chung</h3>
      ...
      <div className="p-5 space-y-8">
        ...
        <div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <FormField label="TÊN CÔNG TRÌNH"  type="input" {...register("tenCongTrinh")} />
            <SelectField label="Đơn vị" options={OPTIONS_DU_TOAN}></SelectField>              
            <FormField label="Ngày tạo" type="date" {...register("tenCongTrinh")} />
          </div>
        </div>
